...
function useOutlet(context) {
  ...
  if (outlet) {
    return _(OutletContext.Provider, { value: context }, outlet);
  }
  return outlet;
}
function useParams() {
...
var RenderErrorBoundary = class extends x {
  ...
  render() {
    return this.state.error !== void 0 ? _(RouteContext.Provider, { value: this.props.routeContext }, _(
...
function RouterProvider({
  ...
  let [state, setStateImpl] = d(router2.state);
    ...
    (newState, { deletedFetchers, flushSync, viewTransitionOpts }) => {
      ...
      if (!viewTransitionOpts || !isViewTransitionAvailable) {
        if (reactDomFlushSyncImpl && flushSync) {
          ...
          R(() => logErrorsAndSetState(newState));
        }
        return;
      }
      if (reactDomFlushSyncImpl && flushSync) {
...
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = getSingleFetchDataStrategyImpl(
    ...
    (match) => {
      let M2 = match;
      return {
        hasLoader: M2.route.hasLoader,
        hasClientLoader: M2.route.hasClientLoader,
        hasComponent: M2.route.hasComponent,
        hasAction: M2.route.hasAction,
        hasClientAction: M2.route.hasClientAction,
        hasShouldRevalidate: M2.route.hasShouldRevalidate
      };
    },
    ...
    (match) => {
      let M2 = match;
      return M2.route.hasComponent && !M2.route.element;
    }
  );
...
function RSCHydratedRouter({
  ...
  if (payload.type !== "render") throw new Error("Invalid payload type");
  let { router: router2, routeModules } = T(
  ...
  let [location2, setLocation] = d(router2.state.location);
  _2(
  ...
  return _(RSCRouterContext.Provider, { value: true }, _(RSCRouterGlobalErrorBoundary, { location: location2 }, _(FrameworkContext.Provider, { value: frameworkContext }, _(RouterProvider, { router: router2, flushSync: En }))));
}
function createRouteFromServerManifest(match, payload) {
  ...
  let dataRoute = {
    ...
    loader: match.clientLoader ? async (args, singleFetch) => {
      ...
      ((_3, singleFetch) => callSingleFetch(singleFetch))
    ),
    ...
    }) : match.hasAction ? (_3, singleFetch) => callSingleFetch(singleFetch) : () => {
