import {
  ...
  removeClass,
  require_prop_types
} from "./chunk-HPCM7V6D.js";
import {
  u
} from "./chunk-LHYVQKVJ.js";
import {
  A,
  D,
  F,
...
var require_browser = __commonJS({
  "node_modules/invariant/browser.js"(exports, module) {
    "use strict";
    var invariant5 = function(condition, format, a, b, c, d2, e, f) {
      if (true) {
        if (format === void 0) {
...
function useUncontrolledProp(propValue, defaultValue, handler) {
  var wasPropRef = A(propValue !== void 0);
  ...
  return [isProp2 ? propValue : stateValue, q(function(value) {
...
function useMergedRefs(refA, refB) {
  return T(() => mergeRefs(refA, refB), [refA, refB]);
}
...
function safeFindDOMNode(componentOrElement) {
  if (componentOrElement && "setState" in componentOrElement) {
    return Rn.findDOMNode(componentOrElement);
  }
  return componentOrElement != null ? componentOrElement : null;
}

// node_modules/react-bootstrap/esm/TransitionWrapper.js
var TransitionWrapper = Rn.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = q(normalize(onEnter), [onEnter]);
  const handleEntering = q(normalize(onEntering), [onEntering]);
  const handleEntered = q(normalize(onEntered), [onEntered]);
  const handleExit = q(normalize(onExit), [onExit]);
  const handleExiting = q(normalize(onExiting), [onExiting]);
  const handleExited = q(normalize(onExited), [onExited]);
  const handleAddEndListener = q(normalize(addEndListener), [addEndListener]);
...
var Collapse = Rn.forwardRef(({
  ...
  const handleEnter = T(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = "0";
  }, onEnter), [computedDimension, onEnter]);
  const handleEntering = T(() => createChainedFunction_default((elem) => {
    const scroll = `scroll${computedDimension[0].toUpperCase()}${computedDimension.slice(1)}`;
    elem.style[computedDimension] = `${elem[scroll]}px`;
  }, onEntering), [computedDimension, onEntering]);
  const handleEntered = T(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  }, onEntered), [computedDimension, onEntered]);
  const handleExit = T(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = `${getDimensionValue(computedDimension, elem)}px`;
    triggerBrowserReflow(elem);
  }, onExit), [onExit, getDimensionValue, computedDimension]);
  const handleExiting = T(() => createChainedFunction_default((elem) => {
    elem.style[computedDimension] = null;
  ...
  return u(TransitionWrapper_default, {
    ...
    unmountOnExit,
    appear,
    children: (state, innerProps) => Rn.cloneElement(children, {
      ...innerProps,
...
var AccordionBody = D(({
  ...
  const {
    eventKey
  } = x(AccordionItemContext_default);
  return u(AccordionCollapse_default, {
    eventKey,
    onEnter,
    onEntering,
    onEntered,
...
var AccordionHeader = D(({
  ...
  return u(Component, {
    ...
    children: u(AccordionButton_default, {
      onClick,
      "aria-controls": ariaControls,
      children
    })
...
var AccordionItem = D(({
  ...
  return u(AccordionItemContext_default.Provider, {
    value: contextValue,
    children: u(Component, {
      ref,
      ...props,
...
var Accordion = D((props, ref) => {
  ...
  return u(AccordionContext_default.Provider, {
    value: contextValue,
    children: u(Component, {
      ref,
      ...controlledProps,
...
init_compat_module();
function useMounted() {
  const mounted = A(true);
  const isMounted = A(() => mounted.current);
  y(() => {
...
var useIsomorphicEffect_default = isDOM || isReactNative ? _ : y;
...
var Fade = D(({
  ...
  const handleEnter = q((node, isAppearing) => {
  ...
  return u(TransitionWrapper_default, {
    ...
    onEnter: handleEnter,
    childRef: getChildRef(children),
    children: (status, innerProps) => _n(children, {
      ...innerProps,
...
// node_modules/react-bootstrap/esm/Alert.js
var Alert = D((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
  ...
  const alert = u("div", {
    ...
    children: [dismissible && u(CloseButton_default, {
      onClick: handleClose,
...
var BreadcrumbItem = D(({
  ...
  return u(Component, {
    ...
    children: active ? children : u(LinkComponent, {
      ...linkProps,
      href,
      title,
      target,
...
function map(children, func) {
  let index = 0;
  return O.map(children, (child) => mn(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  O.forEach(children, (child) => {
    if (mn(child)) func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return O.toArray(children).some((child) => mn(child) && child.type === type);
}
...
var Carousel = (
  ...
  D(({
    ...
    const nextDirectionRef = A(null);
    const [direction, setDirection] = d("next");
    const [paused, setPaused] = d(false);
    const [isSliding, setIsSliding] = d(false);
    const [renderedActiveIndex, setRenderedActiveIndex] = d(activeIndex || 0);
    y(() => {
    ...
    const handleEnter = q((node) => {
      triggerBrowserReflow(node);
      onSlide == null || onSlide(renderedActiveIndex, slideDirection);
    }, [onSlide, renderedActiveIndex, slideDirection]);
    const handleEntered = q(() => {
      setIsSliding(false);
      onSlid == null || onSlid(renderedActiveIndex, slideDirection);
    ...
    const handleMouseOver = q((event) => {
      if (pause === "hover") {
        setPaused(true);
      }
      onMouseOver == null || onMouseOver(event);
    }, [pause, onMouseOver]);
    const handleMouseOut = q((event) => {
      setPaused(false);
      onMouseOut == null || onMouseOut(event);
    }, [onMouseOut]);
    const touchStartXRef = A(0);
    const touchDeltaXRef = A(0);
    const touchUnpauseTimeout = useTimeout();
    const handleTouchStart = q((event) => {
    ...
    const indicatorOnClicks = T(() => indicators && Array.from({
      length: numChildren
    }, (_2, index) => (event) => {
    ...
    return u(Component, {
      ...
      children: [indicators && u("div", {
        className: `${prefix}-indicators`,
        children: map(children, (_2, index) => u("button", {
          type: "button",
          "data-bs-target": "",
        ...
        children: map(children, (child, index) => {
          ...
          return slide ? u(TransitionWrapper_default, {
            in: isActive,
            onEnter: isActive ? handleEnter : void 0,
            onEntered: isActive ? handleEntered : void 0,
            addEndListener: transitionEndListener,
            children: (status, innerProps) => _n(child, {
              ...innerProps,
        ...
        children: [(wrap || activeIndex !== 0) && u(Anchor_default, {
          className: `${prefix}-control-prev`,
          onClick: prev,
          children: [prevIcon, prevLabel && u("span", {
            className: "visually-hidden",
            children: prevLabel
          })]
        }), (wrap || activeIndex !== numChildren - 1) && u(Anchor_default, {
          className: `${prefix}-control-next`,
          onClick: next,
          children: [nextIcon, nextLabel && u("span", {
            className: "visually-hidden",
            children: nextLabel
          })]
        })]
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = A(propValue !== void 0);
  const [stateValue, setState] = d(defaultValue);
  ...
  return [isProp2 ? propValue : stateValue, q((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = h((revision) => revision + 1, 0);
  return dispatch;
}

// node_modules/@restart/ui/esm/DropdownContext.js
init_compat_module();
var DropdownContext = Q(null);
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = A(modifiers);
  const popperInstanceRef = A();
  const update = q(() => {
  ...
  const [popperState, setState] = useSafeState_default(d({
    placement,
    update,
    forceUpdate,
    attributes: {},
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = A(false);
  const waitingForTrigger = A(false);
  const handleMouseCapture = q((e) => {
...
function toModifierArray(map2 = {}) {
  ...
  return Object.keys(map2).map((k2) => {
    map2[k2].name = k2;
    return map2[k2];
  });
}
...
function useDropdownMenu(options = {}) {
  const context6 = x(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = A(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
var $b5e257d569688ac6$var$SSRContext = (0, Rn).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, Rn).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, x)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, d)(true);
  let value = (0, T)(() => ({
  ...
  return (0, Rn).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, Rn).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, Rn)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, Rn).createElement((0, Rn).Fragment, null, props.children);
  }
  return (0, Rn).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, x)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, A)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, Rn).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, Rn).useId();
  let [didSSR] = (0, d)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, Rn)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, Rn)["useSyncExternalStore"] === "function") return (0, Rn)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, x)($b5e257d569688ac6$var$IsSSRContext);
}
...
function useDropdownItem({
  ...
  const onSelectCtx = x(SelectableContext_default);
  const navContext = x(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
init_compat_module();
var Context = Q(canUseDOM_default ? window : void 0);
...
function Dropdown({
  ...
  const lastSourceEvent = A(null);
  const focusInDropdown = A(false);
  const onSelectCtx = x(SelectableContext_default);
  const toggle = q((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  useEventListener(q(() => window2.document, [window2]), "keydown", (event) => {
  ...
  return u(SelectableContext_default.Provider, {
    value: handleSelect,
    children: u(DropdownContext_default.Provider, {
      value: context6,
      children
    })
  });
...
var useIsomorphicEffect_default2 = isDOM2 || isReactNative2 ? _ : y;
...
var DropdownMenu2 = D(({
  ...
  let alignEnd = false;
  const isNavbar = x(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = x(DropdownContext_default2);
  align = align || contextAlign;
  const isInputGroup = x(InputGroupContext_default);
  const alignClasses = [];
  if (align) {
...
var DropdownToggle2 = D(({
  ...
  const dropdownContext = x(DropdownContext_default);
...
var Dropdown2 = D((pProps, ref) => {
  ...
  return u(DropdownContext_default2.Provider, {
    value: contextValue,
    children: u(Dropdown_default, {
      placement,
      show,
      onSelect,
      ...
      children: isInputGroup ? props.children : u(Component, {
        ...props,
        ref,
...
var DropdownButton = D(({
  ...
  flip,
  ...props
}, ref) => u(Dropdown_default2, {
  ref,
  ...props,
  children: [u(DropdownToggle_default2, {
    id,
    href,
    size: size2,
    variant,
...
var FormCheck = D(({
  ...
  return u(FormContext_default.Provider, {
    ...
    children: u("div", {
      ...
      children: children || u(k, {
        children: [input, hasLabel && u(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && u(Feedback_default, {
          type: feedbackType,
...
var FormLabel = D(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return u(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
init_compat_module();
var Switch = D((props, ref) => u(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
// node_modules/react-bootstrap/esm/InputGroup.js
var InputGroupCheckbox = (props) => u(InputGroupText_default, {
  children: u(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => u(InputGroupText_default, {
  children: u(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = D(({
  ...
  const contextValue = T(() => ({}), []);
  return u(InputGroupContext_default.Provider, {
    value: contextValue,
    children: u(Component, {
      ref,
      ...props,
...
function useMergedRefs2(refA, refB) {
  return T(() => mergeRefs2(refA, refB), [refA, refB]);
}
var useMergedRefs_default2 = useMergedRefs2;

// node_modules/@restart/ui/esm/TabContext.js
init_compat_module();
var TabContext = Q(null);
...
function useNavItem({
  ...
  const parentOnSelect = x(SelectableContext_default);
  const navContext = x(NavContext_default);
  const tabContext = x(TabContext_default);
  let isActive = active;
  const props = {
    role
  };
...
function useWaitForDOMRef(ref, onResolved) {
  const window2 = useWindow();
  const [resolvedRef, setRef] = d(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function ImperativeTransition({
  ...
  const [exited, setExited] = d(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default2(ref, getChildRef(children));
  return exited && !inProp ? null : _n(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return u(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
...
function useModalManager(provided) {
  ...
  return Object.assign(modal.current, {
    ...
    setBackdropRef: q((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = D((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = d(!show);
  const lastFocusRef = A(null);
  F(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = A();
  const removeKeydownListenerRef = A();
...
var AbstractModalHeader = D(({
  ...
  const context6 = x(ModalContext_default);
...
var Modal2 = D(({
  ...
  const [modalStyle, setStyle] = d({});
  const [animateStaticModal, setAnimateStaticModal] = d(false);
  const waitingForMouseUpRef = A(false);
  const ignoreBackdropClickRef = A(false);
  const removeStaticModalAnimationRef = A(null);
  const [modal, setModalRef] = useCallbackRef2();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = T(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = q((backdropProps) => u("div", {
    ...backdropProps,
  ...
  return u(ModalContext_default.Provider, {
    value: modalContext,
...
// node_modules/react-bootstrap/esm/Nav.js
var Nav2 = D((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  let isNavbar = false;
  const navbarContext = x(NavbarContext_default);
  const cardHeaderContext = x(CardHeaderContext_default);
  if (navbarContext) {
...
init_compat_module();
init_compat_module();
var NavbarCollapse = D(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context6 = x(NavbarContext_default);
  return u(Collapse_default, {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = d(() => mql ? mql.matches : false);
  useIsomorphicEffect_default2(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = T(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = D(({
  ...
  const modalManager = A();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const [showOffcanvas, setShowOffcanvas] = d(false);
  const handleHide = useEventCallback(onHide);
...
var Overlay = D((props, outerRef) => {
  ...
  const [exited, setExited] = d(!props.show);
  ...
  return container ? Rn.createPortal(child, container) : null;
});
...
var Overlay2 = D(({
  ...
  const popperRef = A({});
  const [firstRenderedState, setFirstRenderedState] = d(null);
...
var OverlayTrigger = ({
  ...
  const handleFocus = q((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = q((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = q((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = q((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = q((...args) => {
  ...
  return u(k, {
    children: [typeof children === "function" ? children(triggerProps) : _n(children, triggerProps), u(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = D(({
  ...
  return u("li", {
    ...
    children: u(Component, {
      ...
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && u("span", {
        className: "visually-hidden",
...
init_compat_module();
var PlaceholderButton = D((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return u(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return u("div", {
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? u("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
...
var ProgressBar = D(({
  ...
  return u("div", {
    ...
    children: children ? map(children, (child) => _n(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
function useTabPanel(_ref) {
  ...
  const context6 = x(TabContext_default);
...
var TabPanel = D(
  ...
  (_ref2, ref) => {
    ...
    return u(TabContext_default.Provider, {
      value: null,
      children: u(SelectableContext_default.Provider, {
        value: null,
        children: u(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
          ...
          mountOnEnter,
          unmountOnExit,
          children: u(Component, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = T(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = T(() => ({
    onSelect,
    activeKey,
    transition,
...
function renderTab(child) {
  ...
  return u(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: u(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var ToastFade = D((props, ref) => u(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = D(({
  ...
  const context6 = x(ToastContext_default);
  const handleClick = useEventCallback((e) => {
...
var Toast = D(({
  ...
  const delayRef = A(delay);
  const onCloseRef = A(onClose);
  y(() => {
  ...
  return u(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? u(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToggleButtonGroup = D((props, ref) => {
  const {
    children,
    type = "radio",
    name,
