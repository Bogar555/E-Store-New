...
var t, r, u, i, o, f, c, e, a, v, l2, m, s, k2;
...
function Y(n) {
  ...
  if (e2.componentWillUnmount = function() {
    G(null, e2.v), e2.v = null, e2.h = null;
  ...
  G(_(Z, { context: e2.context }, n.__v), e2.v);
}
function $(n, e2) {
...
function nn(n, t2, e2) {
  return null == t2.__k && (t2.textContent = ""), G(n, t2), "function" == typeof e2 && e2(), n ? n.__c : null;
}
function tn(n, t2, e2) {
  return J(n, t2), "function" == typeof e2 && e2(), n ? n.__c : null;
}
function rn() {
}
function un() {
  ...
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    l.vnode = function(n) {
      "string" == typeof n.type && (function(n2) {
        ...
        for (var i2 in t2) {
          var l3 = t2[i2];
          if (!("value" === i2 && "defaultValue" in t2 && null == l3 || Q2 && "children" === i2 && "noscript" === e2 || "class" === i2 || "className" === i2)) {
    ...
    Cn = k;
    xn = mn;
    Rn = { useState: d, useId: g, useReducer: h, useEffect: y, useLayoutEffect: _2, useInsertionEffect: I, useTransition: k3, useDeferredValue: w2, useSyncExternalStore: C2, startTransition: R, useRef: A, useImperativeHandle: F, useMemo: T, useCallback: q, useContext: x2, useDebugValue: P, version: "18.3.1", Children: O, render: nn, hydrate: tn, unmountComponentAtNode: bn, createPortal: $, createElement: _, createContext: Q, createFactory: dn, cloneElement: _n, createRef: b, Fragment: k, isValidElement: mn, isElement: xn, isFragment: pn, isMemo: yn, findDOMNode: Sn, Component: x, PureComponent: N, memo: M, forwardRef: D2, flushSync: En, unstable_batchedUpdates: gn, StrictMode: Cn, Suspense: P2, SuspenseList: B2, lazy: z2, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: hn };
  }
});
...
//# sourceMappingURL=chunk-TJX2LDLT.js.map
