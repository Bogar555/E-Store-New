...
var withEmotionCache = function withEmotionCache2(func) {
  return D(function(props, ref) {
    var cache = x(EmotionCacheContext);
  ...
  withEmotionCache = function withEmotionCache3(func) {
    return function(props) {
      ...
      if (cache === null) {
        ...
        return _(EmotionCacheContext.Provider, {
          value: cache
        }, func(props, cache));
      } else {
...
var Insertion$1 = function Insertion(_ref) {
  ...
  if (!isBrowser$2 && rules !== void 0) {
    ...
    return _("style", (_ref2 = {}, _ref2["data-emotion"] = cache.key + " " + serializedNames, _ref2.dangerouslySetInnerHTML = {
      __html: rules
...
var Emotion = withEmotionCache(function(props, cache, ref) {
  ...
  var serialized = serializeStyles$1(registeredStyles, void 0, x(ThemeContext));
...
var LegacySidebarContext = Rn.createContext(void 0);
var SidebarProvider = function(_a) {
  ...
  return Rn.createElement(LegacySidebarContext.Provider, { value: providerValue }, children);
};
var useLegacySidebar = function() {
  var context = Rn.useContext(LegacySidebarContext);
  return context;
};
var useMediaQuery = function(breakpoint) {
  var _a = Rn.useState(!!breakpoint && typeof window !== "undefined" && window.matchMedia(breakpoint).matches), matches = _a[0], setMatches = _a[1];
...
var SidebarContext = Rn.createContext({
  collapsed: false,
  toggled: false,
  rtl: false,
  transitionDuration: 300
});
var Sidebar = Rn.forwardRef(function(_a, ref) {
  var _b;
  ...
  var breakpointCallbackFnRef = Rn.useRef();
  ...
  var _g = Rn.useState(false), mounted = _g[0], setMounted = _g[1];
  ...
  return Rn.createElement(
    ...
    Rn.createElement(
      ...
      Rn.createElement(StyledSidebarContainer, { "data-testid": "".concat(sidebarClasses.container, "-test-id"), className: sidebarClasses.container, backgroundColor }, children),
      image && Rn.createElement(StyledSidebarImage, { "data-testid": "".concat(sidebarClasses.image, "-test-id"), src: image, alt: "sidebar background", className: sidebarClasses.image }),
      broken && toggledValue && Rn.createElement(StyledBackdrop, { "data-testid": "".concat(sidebarClasses.backdrop, "-test-id"), role: "button", tabIndex: 0, "aria-label": "backdrop", onClick: handleBackdropClick, onKeyPress: handleBackdropClick, className: sidebarClasses.backdrop })
    )
  );
});
...
var MenuContext = Rn.createContext(void 0);
var LevelContext = Rn.createContext(0);
  ...
  return Rn.createElement(
    ...
    Rn.createElement(
      ...
      Rn.createElement(
        ...
        Rn.createElement(StyledUl, null, children)
      )
    )
  );
};
var Menu = Rn.forwardRef(MenuFR);
var templateObject_1$8;
var useMenu = function() {
  var context = Rn.useContext(MenuContext);
  if (context === void 0) {
...
var SubMenuContentFR = function(_a, ref) {
  ...
  var defaultOpenState = Rn.useState(defaultOpen)[0];
  return Rn.createElement(
...
var SubMenuContent = Rn.forwardRef(SubMenuContentFR);
...
var usePopper = function(options) {
  ...
  var _a = Rn.useContext(SidebarContext), collapsed = _a.collapsed, toggled = _a.toggled, transitionDuration = _a.transitionDuration;
  var popperInstanceRef = Rn.useRef();
  Rn.useEffect(function() {
...
var MenuButtonRef = function(_a, ref) {
  ...
  if (component) {
    if (typeof component === "string") {
      return Rn.createElement(component, __assign(__assign({ className: classnames(className) }, rest), { ref }), children);
    } else {
      var _b = component.props, classNameProp = _b.className, props = __rest(_b, ["className"]);
      return Rn.cloneElement(component, __assign(__assign(__assign({ className: classnames(className, classNameProp) }, rest), props), { ref }), children);
    }
  } else {
    return Rn.createElement("a", __assign({ ref, className: classnames(className) }, rest), children);
  }
};
var MenuButton = Rn.forwardRef(MenuButtonRef);
...
var SubMenuFR = function(_a, ref) {
  ...
  var level = Rn.useContext(LevelContext);
  var _e = Rn.useContext(SidebarContext), collapsed = _e.collapsed, rtl = _e.rtl, sidebarTransitionDuration = _e.transitionDuration;
  ...
  var _g = Rn.useState(!!defaultOpen), open = _g[0], setOpen = _g[1];
  var _h = Rn.useState(false), openWhenCollapsed = _h[0], setOpenWhenCollapsed = _h[1];
  var _j = Rn.useState(false), mounted = _j[0], setMounted = _j[1];
  var buttonRef = Rn.useRef(null);
  var contentRef = Rn.useRef(null);
  var timer = Rn.useRef();
  ...
  var expandContent = Rn.useCallback(function() {
    var _a2;
  ...
  return Rn.createElement(
    ...
    Rn.createElement(
      ...
      icon && Rn.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getSubMenuItemStyles("icon") }, icon),
      prefix2 && Rn.createElement(StyledMenuPrefix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getSubMenuItemStyles("prefix") }, prefix2),
      Rn.createElement(StyledMenuLabel, { className: classnames(menuClasses.label, sharedClasses), rootStyles: getSubMenuItemStyles("label") }, label),
      suffix && Rn.createElement(StyledMenuSuffix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getSubMenuItemStyles("suffix") }, suffix),
      Rn.createElement(StyledExpandIconWrapper, { rtl, className: classnames(menuClasses.SubMenuExpandIcon, sharedClasses), collapsed, level, rootStyles: getSubMenuItemStyles("SubMenuExpandIcon") }, renderExpandIcon ? renderExpandIcon({
        level,
        disabled,
        active,
        open: openControlled !== null && openControlled !== void 0 ? openControlled : open
      }) : collapsed && level === 0 ? Rn.createElement(StyledExpandIconCollapsed, null) : Rn.createElement(StyledExpandIcon, { rtl, open: openControlled !== null && openControlled !== void 0 ? openControlled : open }))
    ),
    Rn.createElement(
      SubMenuContent,
      ...
      Rn.createElement(LevelContext.Provider, { value: level + 1 }, children)
    )
  );
};
var SubMenu = Rn.forwardRef(SubMenuFR);
...
var MenuItemFR = function(_a, ref) {
  ...
  var level = Rn.useContext(LevelContext);
  var _e = Rn.useContext(SidebarContext), collapsed = _e.collapsed, rtl = _e.rtl, transitionDuration = _e.transitionDuration;
  ...
  return Rn.createElement(
    ...
    Rn.createElement(
      ...
      icon && Rn.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getMenuItemStyles("icon") }, icon),
      prefix2 && Rn.createElement(StyledMenuPrefix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getMenuItemStyles("prefix") }, prefix2),
      Rn.createElement(StyledMenuLabel, { className: classnames(menuClasses.label, sharedClasses), rootStyles: getMenuItemStyles("label") }, children),
      suffix && Rn.createElement(StyledMenuSuffix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getMenuItemStyles("suffix") }, suffix)
    )
  );
};
var MenuItem = Rn.forwardRef(MenuItemFR);
...
var ProSidebarProvider = function(_a) {
  ...
  return Rn.createElement(SidebarProvider, null, children);
};
var useProSidebar = function() {
  ...
  var collapseSidebar = Rn.useCallback(
    function(value) {
      if (value === void 0)
  ...
  var toggleSidebar = Rn.useCallback(
    function(value) {
      if (value === void 0)
